...
if __name__ == '__main__':
    ...
    #set path
    dataset_name =  'AMZN_GME_synthetic'         #AMZN_GME, AMZN_GME_synthetic
    ...
    # #save path
    folder = 'synthetic'   #oracle, synthetic
    save_path = "./models/" + folder + "/" + "seed_" + str(seed) 
    
    #uncomment below line if you do not want to save the model
    #save_path="" 
    ...
    dataset1_name =  'AMZN_synthetic'         #AMZN_10-20, AMZN_synthetic
    file_path1 = './datasets/' + dataset_name + '_preprocessed.npy'

    dataset2_name =  'GME_synthetic'         #GME_10-20, GME_synthetic
    ...
    # samples_amzn = model_amzn.get_prior_samples(2489)
    # samples_gme = model_gme.get_prior_samples(2489)

    # samples_amzn = model_amzn.scaler.inverse_transform(samples_amzn)
    # samples_gme = model_gme.scaler.inverse_transform(samples_gme)

    # np.save('./datasets/AMZN_synthetic_preprocessed.npy', samples_amzn)
    # np.save('./datasets/GME_synthetic_preprocessed.npy', samples_gme)