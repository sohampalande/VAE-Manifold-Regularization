...
if __name__ == '__main__':
    ...
    mask = [1 if mnist[i][1] == 6 or mnist[i][1] == 4 else 0 for i in range(len(mnist))]   #change digits as per requirement of dataset
    ...
    path = './MNIST_results/' + experiment_directory + '/models/vae_model_1.pt'

    vae_model_1 = torch.load(path)

    reconstruction_space_path = "./MNIST_results/0-9_6-4/models/transfer_learning_latent_space/reconstruction_space_"
    latent_space_path = "./MNIST_results/0-9_6-4/models/transfer_learning_latent_space/latent_space_"
    synthetic_data_path = "./MNIST_results/0-9_6-4/models/transfer_learning_latent_space/syn_data_"

    if not save_video:
        synthetic_data_path=""

    vae_model_1_transfer = vae_model_1.train_transfer(data=trainloader_transfer, joint_data=trainloader_joint, reconstruction_space_path=reconstruction_space_path, latent_space_path=latent_space_path, synthetic_data_path=synthetic_data_path, epochs=epochs, lr=lr)

    path = './MNIST_results/' + experiment_directory + '/models/vae_model_1_transfer.pt'
    torch.save(vae_model_1_transfer, path) #save model
    ...
    video_path_recons = './MNIST_results/0-9_6-4/models/transfer_learning_videos/reconstruction_space.avi'
    video_path_latent = './MNIST_results/0-9_6-4/models/transfer_learning_videos/latent_space.avi'
    video_path_synthetic = './MNIST_results/0-9_6-4/models/transfer_learning_videos/synthetic_data.avi'
    ...
    viz.plot_reconstructions_normal(vae_model_1_transfer)
    ...
    samples = viz.generate_samples(vae_model_1_transfer, n_tsne)
